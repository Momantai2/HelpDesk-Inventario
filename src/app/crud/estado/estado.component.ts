...
import { EstadoRequestDTO, EstadoResponseDTO } from '../../model/estado.model';
...
export class EstadoComponent implements OnInit {
  ...
  estadoEnModal: Partial<EstadoResponseDTO> = {};
  ...
  constructor(
    private crudService: CrudService<EstadoResponseDTO, EstadoRequestDTO>,
  ...
  abrirEditar(estado: EstadoResponseDTO): void {
  ...
  abrirVer(estado: EstadoResponseDTO): void {
    this.modalModo = 'ver';
  ...
  confirmarAccionModal(): void {
    if (this.modalModo === 'crear') {
      this.crudService
        .create('estados', this.estadoEnModal as EstadoRequestDTO)
        .subscribe({
          next: () => {
            this.getEstados();
    ...
    if (this.modalModo === 'editar') {
      this.crudService
        .update(
          'estados',
          this.estadoEnModal.idEstado!,
          this.estadoEnModal as EstadoRequestDTO
        )
        .subscribe({
          next: () => {
            this.getEstados();
