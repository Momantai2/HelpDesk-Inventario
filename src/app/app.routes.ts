...
export const routes: Routes = [
  ...
  component: MainLayoutComponent,
    ...
    { path: 'ticket', component: TicketComponent , canActivate: [RoleGuard],data: { roles: [1] }},
    { path: 'comentario', component: ComentarioComponent , canActivate: [RoleGuard],data: { roles: [1] }},
    { path: 'estado', component: EstadoComponent , canActivate: [RoleGuard],data: { roles: [1] }},
    { path: 'usuario', component: UsuarioComponent , canActivate: [RoleGuard],data: { roles: [1] }},
    { path: 'prioridad', component: PrioridadComponent , canActivate: [RoleGuard],data: { roles: [1] }}, 
    { path: 'home', component: HomeComponent , canActivate: [RoleGuard],data: { roles: [1,3] }},]
    }
];
